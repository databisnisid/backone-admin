...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "landing/img/backone.png",
    ...
    "order_with_respect_to": ["auth", "backone", "orbit", "connection"],
    # Custom links to append to app groups, keyed on app name
    "custom_links": {
        "backone": [{
            "name": "Map",
            "url": "http://127.0.0.1:8000/landing/map/",
            "icon": "fas fa-comments",
            "permissions": ["landing.view_landing"]
        }]
    },
