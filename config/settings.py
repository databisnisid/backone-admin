...
# ORBIT SINGLE
ORBIT_EMAIL_ADDRESS = os.getenv("ORBIT_EMAIL_ADDRESS")
ORBIT_EMAIL_PASSWORD = os.getenv("ORBIT_EMAIL_PASSWORD")

# ORBIT MULTI
ORBIT_MULTI_USERNAME = os.getenv("ORBIT_MULTI_USERNAME")
ORBIT_MULTI_PASSWORD = os.getenv("ORBIT_MULTI_PASSWORD")
ORBIT_MULTI_EMAIL_ADDRESS = os.getenv("ORBIT_MULTI_EMAIL_ADDRESS")
ORBIT_MULTI_EMAIL_PASSWORD = os.getenv("ORBIT_MULTI_EMAIL_PASSWORD")
ORBIT_MULTI_EMAIL_HOST = os.getenv("ORBIT_MULTI_EMAIL_HOST")
# DSC
...
# DSC 2
DSC_USERNAME_2 = os.getenv("DSC_USERNAME_2")
DSC_PASSWORD_2 = os.getenv("DSC_PASSWORD_2")
DSC_EMAIL_ADDRESS_2 = os.getenv("DSC_EMAIL_ADDRESS_2")
DSC_EMAIL_PASSWORD_2 = os.getenv("DSC_EMAIL_PASSWORD_2")
