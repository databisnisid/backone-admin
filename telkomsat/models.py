...
class Starlink(models.Model):
    ...
    msisdn = models.CharField(
        max_length=50, unique=True, verbose_name=_("Service Line Number")
    )
    kit_serialnumber = models.CharField(
        max_length=50, blank=True, verbose_name=_("KIT Serial Number")
    )
    quota_total = models.CharField(
        max_length=20, blank=True, verbose_name="Kuota Total", default="40 GB"
    )
    quota_current = models.CharField(
        max_length=20, blank=True, verbose_name="Kuota Saat Ini"
    )
    quota_usage = models.CharField(
        max_length=20, blank=True, verbose_name="Kuota Usage"
    )
    ...
    activation_date = models.DateField(verbose_name=_("Tanggal Aktivasi"), blank=True)
    ...
    quota_type = models.CharField(
        max_length=20, default="starlink", verbose_name="Quota Type"
    )
